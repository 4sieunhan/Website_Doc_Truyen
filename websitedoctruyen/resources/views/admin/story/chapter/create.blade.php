...
@section('content')
@section('h1','Thêm mới chương')
@section('button','Tạo Mới')
  <!-- Main content -->
<form enctype="multipart/form-data" method="POST" action="{{route('admin.story.chapter.store',['id' => $data->id])}}">
@csrf
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="card">
            ...
            <h1 class="card-title">@yield('h1')({{$data->name}})</h1>
            </div>
          <div class="card">
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <div class="form-group col-12">
                  ...
                  <button type="button" onclick="location.href='{{route('admin.story.chapter.list',['id'=>$data->id])}}'" class="btn btn-primary float-right col-5"></i> 
                      Quay lại
                  </button>
                </div>
            </div>
