...
@section('content')
@section('h1','Chỉnh sửa chuyên mục')
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <div class="form-group">
                        ...
                        <input type="text" name="name" value="{{$categories->name}}" class="form-control" id="exampleText" placeholder="Nhập tên của chuyên mục">
                     </div>
                     @if ($errors->has('name'))
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" name="keyword" value="{{$categories->keyword}}" class="form-control" id="exampleText" placeholder="Từ khóa 1,từ khóa 2,từ khóa 3">
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        <select name="parent_id" value="{{$categories->parent_id}}" class="form-control">
                           <option value="0">Please choose your category</option>
                        </select>
                     </div>
                     <div class="form-group">
                        <label for="exampleInputEmail1">Mô Tả</label>
                        <textarea name="description" value="{{$categories->description}}" class="form-control" rows="5" cols="5" id="exampleText"></textarea>
                     </div>
