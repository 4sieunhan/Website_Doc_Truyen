...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
          <div class="row mb-2">
            <h4 class="card-title col-sm-8">{{$stories->name}}</h4>
            <button type="button" onclick="location.href='{{route('admin.story.chapter.create',['id' => $stories->id])}}'" class="btn btn-primary btn-rounded btn-fw col-sm-2">
