...
@section('content')
@section('form-title','Sửa Chuyên Mục')
...
<div class="row clearfix">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
			...
			<div class="body">
				<form id="form_advanced_validation" action="{{route('admin.category.update',['id' => $categories->id])}}" method="POST">
					@csrf
					...
					<div class="form-group form-float">
						<div class="form-line">
							<input type="text" class="form-control" name="keyword" value="{{$categories->keyword}}">
					...
					<div class="form-group form-float">
						<div class="form-line">
							...
							<textarea name="description" id="ckeditor" cols="30" rows="5" value="{{$categories->description}}" class="form-control no-resize"></textarea>
						</div>
						<div class="help-info">
