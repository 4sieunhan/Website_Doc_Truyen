...
@section('content')
@section('form-title','Danh Sách Chương')
@section('form-name','Truyện')
<div class="block-header">
	<h2>
        @yield('form-name') {{$stories->name}}
        <button type="button" onclick="location.href='{{route('admin.story.chapter.create',['id' => $stories->id])}}'" style="float:right;" class="btn bg-red waves-effect">
        <i class="material-icons">add_circle_outline</i>
        <span>Thêm Mới Chương</span>
        </button>
		...
		<button type="button" onclick="location.href='{{route('admin.story.chapter.show')}}' " style="float:right;" class="btn bg-red waves-effect">
		<i class="material-icons">add_circle_outline</i>
